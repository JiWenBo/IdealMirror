...
public class OrderSub {
     ...
     * result : 1
     * msg :
     * data : {"order_id":"1460772966AVb","address":{"addr_id":"729","username":"159","cellphone":"159","addr_info":"159","zip_code":"","city":""},"goods":{"goods_name":"GENTLE MONSTER","goods_num":"","des":"BIG BULLY 飛行員太陽鏡","price":"1300","pic":"http://7xprhi.com2.z0.glb.qiniucdn.com/gmsliver155cbc9a39c911ee63efda10378130330.jpg","book_copy":"文案（订购商品）文案（订购商品）文案（订购商品）文案（订购商品）"},"if_ordain":"1"}
     */

    private String result;
    private String msg;
    /**
     * order_id : 1460772966AVb
     * address : {"addr_id":"729","username":"159","cellphone":"159","addr_info":"159","zip_code":"","city":""}
    ...
    public static OrderSub objectFromData(String str) {

        return new Gson().fromJson(str, OrderSub.class);
    }
