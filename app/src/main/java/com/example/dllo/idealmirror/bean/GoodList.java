...
public class GoodList {
    ...
    public static GoodList objectFromData(String str) {

        return new Gson().fromJson(str, GoodList.class);
    }
    ...
    public static class DataEntity {
        ...
        public static class ColorDataEntity {
            ...
            public static ColorDataEntity objectFromData(String str) {

                return new Gson().fromJson(str, ColorDataEntity.class);
            }
