...
public class MrtjListBean {
    ...
    public static MrtjListBean objectFromData(String str) {

        return new Gson().fromJson(str, MrtjListBean.class);
    }
    ...
    public static class DataEntity {
        ...
        public static class ListEntity {
            ...
            public static class DataInfoEntity {
                ...
                public static DataInfoEntity objectFromData(String str) {

                    return new Gson().fromJson(str, DataInfoEntity.class);
                }
